...
export default function Navbar() {
    ...
    return (
        <nav className="flex relative z-50 items-center bg-zinc-900/60 backdrop-blur-lg justify-between px-5 py-2 w-screen">
            ...
            <div className="flex gap-2 items-center">
                <details className="list-none">
                    ...
                    <div className="flex flex-col gap-2 absolute w-36 bg-zinc-900/60 backdrop-blur-lg border border-zinc-600 px-3 py-2 rounded-md -translate-x-24 translate-y-3">
                        <Link href={`/user/profile`} className="w-full flex justify-between items-center">Profile <Icon icon="chevron_right"/></Link>
